function [Spp, Spr, Srp, Srr] = GSM_V2_SameAzimuth(Nr, Np, F, rp, rr, erp, murp, err, murr, X_)
...
[Qp, Zp, Yp] = QZcalculation_v4_SameAzimuth(Np, F, rp, erp, murp, rho_, phi_, zp, drho, dphi);
...
[Qr, Zr, Yr] = QZcalculation_v4_SameAzimuth(Nr, F, rr, err, murr, rhor_, phir_, zr, drho, dphi);
