...
hold on;
plot(F_cst * 1e-9, db(abs(squeeze(s_params_5_cst(1,71, :)))), 'LineWidth', 2); grid on;
hold on;
plot(F_feko * 1e-9, db(abs(squeeze(s_params_5_feko(1, 11, :)))), 'LineWidth', 2); grid on;
...
hold on;
plot(F_cst * 1e-9, angle((squeeze(s_params_5_cst(1, 71, :)))) * 180/pi, 'LineWidth', 2); grid on;
hold on;
plot(F_feko * 1e-9, angle((squeeze(s_params_5_feko(1, 11, :)))) * 180/pi, 'LineWidth', 2); grid on;
...
hold on;
plot(F_feko * 1e-9, db(abs(squeeze(s_params_5_feko(11, 1, :)))), 'LineWidth', 2); grid on;
...
hold on;
plot(F_feko * 1e-9, angle((squeeze(s_params_5_feko(11, 1, :)))) * 180/pi, 'LineWidth', 2); grid on;
