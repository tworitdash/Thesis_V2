...
problem2.fitnessfcn = @(x) Ga_opt_aper_eff_freq([x(1:N)], x(N + 1), F, 5, focal_length, d);
problem2.nvars = N + 1;
...
%     true, 'FitnessLimit',  -0.5);
problem2.options = optimoptions(@gamultiobj, 'PlotFcn', @gaplotpareto, 'Display', 'iter',... 
    'InitialPopulationMatrix', [IP], 'UseParallel',...
    true);
...
[r, fval2, exf2, ouput2] = gamultiobj(problem2);
...
save('ga_allvar_ms3serv2_maxeap_multi.mat', 'fmin2'); %minxp is for minimum cross polarization