...
data5_feko = read(rfdata.data,'../../../feko/Cone_V1_feko.s25p');
...
hold on;
plot(F_feko * 1e-9, db(abs(squeeze(s_params_5_feko(1, 1, :)))), 'LineWidth', 2); grid on;
...
hold on;
plot(F_feko * 1e-9, db(abs(squeeze(s_params_5_feko(1, 21, :)))), 'LineWidth', 2); grid on;
...
hold on;
plot(F_feko * 1e-9, angle((squeeze(s_params_5_feko(1, 21, :)))) * 180/pi, 'LineWidth', 2); grid on;
...
hold on;
plot(F_feko * 1e-9, db(abs(squeeze(s_params_5_feko(21, 1, :)))), 'LineWidth', 2); grid on;
...
hold on;
plot(F_feko * 1e-9, angle((squeeze(s_params_5_feko(21, 1, :)))) * 180/pi, 'LineWidth', 2); grid on;
...
hold on;
plot(F_feko * 1e-9, db(abs(squeeze(s_params_5_feko(21, 21, :)))), 'LineWidth', 2); grid on;
...
hold on;
plot(F_feko * 1e-9, angle((squeeze(s_params_5_feko(21, 21, :)))) * 180/pi, 'LineWidth', 2); grid on;
