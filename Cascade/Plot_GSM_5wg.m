...
plot(F * 1e-9, angle((squeeze(STT(:, 5, 5)))) * 180/pi, 'LineWidth', 2); grid on;
hold on;
...
hold on;
plot(F_cst * 1e-9, db(abs(squeeze(s_params_5_cst(9,80, :)))), 'LineWidth', 2); grid on;
hold on;
...
plot(F * 1e-9, angle((squeeze(STR(:, 5, 5)))) * 180/pi, '*', 'LineWidth', 1); grid on;
hold on;
plot(F_cst * 1e-9, angle((squeeze(s_params_5_cst(7, 77, :)))) * 180/pi, 'LineWidth', 2); grid on;
hold on;
...
plot(F * 1e-9, db(abs(squeeze(SRT(:, 4, 5)))), 'LineWidth', 2); grid on;
hold on;
