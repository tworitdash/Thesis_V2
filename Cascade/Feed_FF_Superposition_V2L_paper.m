function [Eth, Eph, Eco, Exp, CO, XP] = Feed_FF_Superposition_V2L_paper(ModeNumberAper, theta, phi, F, er, mur, R, Transmission_sum)
...
for o = 1:ModeNumberAper
    ...
    [Eth_o, Eph_o, Eco_o, Exp_o, CO_o, XP_o] = FF_apertureFSCir4_paper(o, 1, 0, theta, phi, F, er(end), mur(end), R(end), R(1));
