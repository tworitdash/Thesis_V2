...
% 
% [Yin, Gamma_K] = Mishustin_K_Space(r, k0, L, er, mur, len);
...
% hold on;
% plot(x, real(Yin), '*', 'Linewidth', 1);
% hold on;
% plot(x, imag(Yin), '*', 'Linewidth', 1);
...
% hold on;
% plot(f, db(abs(Gamma_K)), '*', 'Linewidth', 1);
grid on;
hold on;
...
% figure;
% hold on;
% plot(x, real(Gamma), 'o', 'Linewidth', 1);
% hold on;
% plot(x, imag(Gamma), 'o', 'Linewidth', 1);
% hold on;
% plot(x, real(Gamma_11), '-.', 'Linewidth', 1);
% hold on;
% plot(x, imag(Gamma_11), '-.', 'Linewidth', 1);